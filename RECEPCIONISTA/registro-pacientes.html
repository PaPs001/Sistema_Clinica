...
<head>
    ...
    <title>Registrar Pacientes - Clínica "Ultima Asignatura"</title>
    <link rel="stylesheet" href="style-recepcionista.css">
    <link rel="stylesheet" href="style-registro-paciente.css">
...
<body>
    <div class="dashboard-container">
        ...
        <div class="sidebar">
            ...
            <nav class="sidebar-nav">
                ...
                <a href="registro-pacientes.html" class="nav-item active">
    ...
    <script src="script-registro-paciente.js"></script>
</body>
</html>